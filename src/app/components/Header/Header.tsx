					...
					<AppBar className={classes.bar} position="fixed">
						<Toolbar className={classes.justifyCenter}>
							...
							<MenuItem onClick={this.openMobileMenu}
								...
								<img className={classes.logoutIcon} src="../../../assets/icons/mobile_menu.svg" alt="No image" />
								<Typography className={classes.typo}>Menu</Typography>

							</MenuItem>
							<MenuItem onClick={() => this.handleChooseUser(true)}>
								<Typography className={classes.typo}>{this.props.userStore.user.personalCode}&nbsp;</Typography>
